...
Home Page Upon accessing the application, you'll see the home page. Use the navigation menu to explore the features.

Manage Book Records Add Books: Use the "Add Book" option to enter book details. Update Books: Click on a book and choose betweeen "Avalable" and "Rented" to modify its information. Delete Books: Select a book and click "Delete" to remove it.

Search for Books Utilize the search bar to find books quickly by title or author.

Session Management User sessions ensure secure interactions. Log in or manage your session as prompted.
